...
public class login extends javax.swing.JFrame {
                        ...
                        public static String theusertype="";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
                java.sql.Connection myconn = DriverManager.getConnection(myurl1, uname, upass);
                try
                {
                        String q="select * from manageemployee where username=? and password=?";

                        PreparedStatement myst = myconn.prepareStatement(q);
                        myst.setString(1, jTextField1.getText());
                        theusername=jTextField1.getText();
                        myst.setString(2, jPasswordField1.getText());
                        ResultSet myres = myst.executeQuery();

                        if(myres.next()==true)
                        {
                                theusertype=myres.getString("position");
